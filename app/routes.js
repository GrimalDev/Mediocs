module.exports = function(app, passport, fs, bcrypt, adminSecret, user_database) {
    ...
    app.get('/users', checkAuthenticated, checkIfAdmin, (req, res) => {
        res.render('users')
    })
    ...
    app.get('/userData', checkAuthenticated, checkIfAdmin, (req, res) => {
        require('./config/userData-config.js')(user_database, bcrypt, adminSecret, req, res)
    })

    app.get('/userData/modify', checkAuthenticated, checkIfAdmin, (req, res) => {
